...
public class Group_Color extends AppCompatActivity {
    ...
    public void color1_checked(View view) {
        ...
        intent.putExtra("result", "color1"); // 입력폼에 적은 값 담아주기
    ...
    public void color2_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color2"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        finish();
    }
    public void color3_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color3"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color4_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color4"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color5_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color5"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color6_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color6"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color7_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color7"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color8_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color8"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color9_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color9"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color10_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color10"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color11_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color11"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
    public void color12_checked(View view) {
        Intent intent = new Intent();
        intent.putExtra("result", "color12"); // 입력폼에 적은 값 담아주기
        setResult(RESULT_OK, intent); // 결과 값 설정
        this.finish();
    }
}
